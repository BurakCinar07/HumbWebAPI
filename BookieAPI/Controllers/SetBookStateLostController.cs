...
{
    public class SetBookStateLostController : ApiController
    {
        Context context = new Context();
        BaseResponse response = new BaseResponse();

        [HttpPost]
        public JsonResult<BaseResponse> UpdateBookState([FromBody] JObject post)
        {
        ...
        private void OnSuccess(Object s, EventArgs e)
        {
            ...
            bool didStateChanged = BookUtils.SetBookStateLost(context, email, bookID);
